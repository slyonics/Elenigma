...
namespace Elenigma.Models
{
    ...
    public class HeroModel : BattlerModel
    {
        ...
        public ModelProperty<string> Sprite { get; set; } = new ModelProperty<string>(GameSprite.Battlers_AdvF.ToString());
        public ModelProperty<string> BattleSprite { get; set; } = new ModelProperty<string>(GameSprite.Battlers_AdvF.ToString());
        public ModelProperty<string> PortraitSprite { get; set; } = new ModelProperty<string>(GameSprite.Battlers_AdvF.ToString());
