    ...
    public class SystemViewModel : ViewModel
    {
        ...
        public void Save(object parameter)
        {
            ...
            if (AvailableSaves[saveSlot].Location.Value == "- Empty Save -")
            {
                ...
                string portrait1 = GameProfile.PlayerProfile.Party[0].PortraitSprite.Value;
                string portrait2 = GameProfile.PlayerProfile.Party.Count() > 1 ? GameProfile.PlayerProfile.Party[1].PortraitSprite.Value : GameSprite.Actors_Blank.ToString();
