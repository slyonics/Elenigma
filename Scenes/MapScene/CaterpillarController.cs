...
namespace Elenigma.Scenes.MapScene
{
    ...
    public class CaterpillarController : Controller
    {
        ...
        public override void PostUpdate(GameTime gameTime)
        {
            if (movementList != null)
            {
                ...
                if (walkTimeLeft > 0.0f)
                {
                    ...
                    int heroOffset = (int)(interval * mapScene.Tilemap.TileSize);
        ...
        private void FindInteractables()
        {
            ...
            {
                case Orientation.Up:
                    interactZone = player.Bounds; interactZone.Y -= zoneHeight;
                    break;
                case Orientation.Right:
                    interactZone = player.Bounds; interactZone.X += zoneHeight;
                    break;
