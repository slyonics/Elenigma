...
namespace Elenigma.Scenes.BattleScene
{
    public class BattleScene : Scene
    {
        ...
        public BattleScene(string encounterName, TerrainType terrainType)
            : this(encounterName, terrainType.ToString())
        {

        }

        public BattleScene(string encounterName, string terrainType)
        {
